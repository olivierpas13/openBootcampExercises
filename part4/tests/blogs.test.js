...
describe('Favorite blog', () => {
  test('of empty list is undefined', () => {
    expect(listHelper.favoriteBlog(noBlogs)).toBeUndefined();
  });

  test('when a list has only one blog equals to the same blog', () => {
...
describe('The author with most blogs', () => {
  test('of empty list is undefined', () => {
    expect(listHelper.mostBlogs(noBlogs)).toBeUndefined();
  });

  test('when a list has only one blog equals to the same author', () => {
    expect(listHelper.mostBlogs(oneBlog)).toEqual({ author: 'Edsger W. Dijkstra', blogs: 1 });
  });
...
describe('The author with most likes', () => {
  test('of empty list is undefined', () => {
    expect(listHelper.mostLikes(noBlogs)).toBeUndefined();
  });

  test('when a list has only one blog equals to the same author', () => {
    expect(listHelper.mostLikes(oneBlog)).toEqual({ author: 'Edsger W. Dijkstra', likes: 5 });
  });
